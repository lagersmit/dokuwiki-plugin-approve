...
class action_plugin_approve_approve extends DokuWiki_Action_Plugin {
    ...
    public function handle_approve(Doku_Event $event) {
        ...
        /* msg("Approved ".$INFO['id']); */
        $temp = p_get_metadata($INFO['id'])['last_change'];
        $temp["sum"] = "Approved";
        $temp["type"] = "E";

        p_set_metadata($INFO['id'],array('sum' => "Approved", "last_change" => $temp));
        $changelog_file = metaFN($INFO['id'], '.changes');
        ...
        /* print("<pre>"); */
        /* print_r(p_get_metadata($INFO['id'])); */
        /* print_r($temp); */
        /* print("</pre>"); */
